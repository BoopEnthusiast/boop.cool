                ...
                <Parallax pages={2} style={{ top: '0', left: '0' }}>
                    ...
                    <ParallaxLayer offset={0} speed={1}>
                        <div className='boxes'>
                            ...
                            <PresentBox image='/games/Snakerosion.png' imageAlt='A vibrant red snake coming toward the screen with a :3 face with the text "SNAKE-ROSION"' title='Snakerosion' id='snakerosion' link='https://boopenthusiast.itch.io/snake-rosion'
